...
#ifndef SQUARE_UP__H_
#define SQUARE_UP__H_
...
{
public:
  void init(double myBlueThres = 170, double myRedThres = 170,
            double myYellowThres = 200, int myProdThres = 3,
            string squareParameter = "/home/yf/ws/src/drone/uav_vision/squareParameter.yml")
  {
   ...
   */
  vector< vector<cv::Point> > detect(cv::Mat src, Mat &dst)
  {
    cv::Mat srcCopy;
    src.copyTo(srcCopy);
